<main role="main" class="flex-shrink-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1 class="mt-2">Cadastro de Usuarios</h1>
                <?php
                ...
                <form action="<?php echo 'http://' . APP_HOST . '/usuario/salvar/novo'; ?>" method="post"
                    ...
                    <br>
                    <button type="submit" class="btn btn-outline-success"> <i class="bi bi-floppy"></i>
                        Salvar</button>
                    <!-- <buton type="reset" class="btn btn-outline-danger"> <i class="bi bi-x-circle"></i>
                        Limpar</button> -->

                    <a href="http://<?php echo APP_HOST . "/usuario/listar"; ?>" class="btn btn-outline-danger"
                        title="Editar produto <?= htmlspecialchars($id) ?>"
                        aria-label="Editar produto <?= htmlspecialchars($id) ?>"><i class="bi bi-x-circle"></i>
                        Cancelar</a>
