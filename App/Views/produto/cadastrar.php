                ...
                <form action="<?php echo 'http://'.APP_HOST.'/produto/salvar/novo';?>" method="post" id="formCadastro">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nome"
                            value="<?php if (isset($viewVar['produto'])) echo $viewVar['produto']->getNome();?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="descricao">Descrição</label>
                        <textarea class="form-control"
                            name="descricao"><?php if (isset($viewVar['produto'])) echo $viewVar['produto']->getDescricao();?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="preco">Preço</label>
                        R$ <input type="text"
                            class="form-control <?php if ($Sessao::retornaErro('erropreco')!="") echo "is-invalid"; ?>"
                            name="preco"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="quantidade"
                            value="<?php if (isset($viewVar['produto'])) echo $viewVar['produto']->getQuantidade();?>"
                            required>
                    </div>
                    <br>
